...
namespace HomeWork_1
{
    ...
    class PrintStudent
    {
        ...
        {
            return new Student(InputName(), InputAddress(), InputCitizenID(), InputStudentID(),InputGender());
        }
    ...
    class PrintTeacher
    {
        ...
        {
            return new Teacher(InputName(), InputAddress(), InputCitizenID(), InputEmployeeID(), InputGender());
        }
        public static string InputName()
        {
            Console.Write("Name :");
    ...
    class Person
    {
        ...
        public Person(string name, string address, string citizanID, string gender) 
        {
            this.Name = name;
    ...
    class Student : Person
    {
         ...
         public Student(string name, string address, string citizanID, string studentID,string gender) : base(name, address, citizanID,gender)
         {
    ...
    class Teacher : Person
    {
         ...
         public Teacher(string name, string address, string citizanID, string employeeID, string gender) :base(name, address, citizanID,gender)
         {
